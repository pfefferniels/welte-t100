...
export const T98_SCALING: Scaling = {
 ...
 */
function deliveryDump(lift: Float64Array, dt: Float64Array, riseMs: number, fallMs: number): Float64Array {
...
export function runNuancing(input: ModelInput, params: Parameters): NuancingOutput {
...
export function sforzandoPianoLift(input: ModelInput, params: Parameters): Float64Array {
  return t98Relay(input, { ...DEFAULTS, ...params }).sforzandoPiano;
}

export const pneumaticT98Model: Model = {
  name: "pneumatic-t98",
