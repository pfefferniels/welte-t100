...
import { geometryInMm, ROWS_PER_MM, type PortGeometry } from "../core/aperture.ts";
 ...
 */
export const PUNCH_T98_MM = 1.594;
 ...
 */
export const TRACKER_BORE_T98_MM = 1.413;
 ...
 */
export const CHAIN_GAP_MM = 1.8;

export const CHAIN_GAP_ROWS = CHAIN_GAP_MM * ROWS_PER_MM;

export const DEFAULT_T98_GEOMETRY: PortGeometry = geometryInMm(PUNCH_T98_MM, TRACKER_BORE_T98_MM);
