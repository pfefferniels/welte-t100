 ...
 * midi2exp used before 2021 (`docs/sources.md` §1). The two agree on roll 3309
 * to within 1.6 % of the local step and 0.7 % of the total duration, so the
 * choice is a question of provenance rather than of fit.
 */

import { parseSmf, type SmfFile, type TrackEvent } from "../core/smf.ts";
import { paperSeconds, WELTE_SPOOL, type Spool } from "../core/spool.ts";
