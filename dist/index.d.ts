...
export { halfPedalling, pedalBrushing, pedalDefaults, pedalSpec, pedalSpans, runPedals, tiedToRise, type HalfPedalling, type PedalInput, type PedalSpan, type PedalTravel, } from "./core/pedal.ts";
