 ...
 */
function conductanceFor(fraction, ms, alpha) {
 ...
 */
function travelOf(input, set, alpha, towards, away) {
 ...
 */
function relayOf(input, latch, alpha, lagMs) {
    if (lagMs <= 0)
        return latch;
    const steps = input.grid.dt;
 ...
 */
export function tiedToRise(params) {
...
export function halfPedalling(spans, margin = 0.02) {
