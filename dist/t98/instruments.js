...
export const STARTING_VALUES = {
    ...
    provenance: {
        source: "Model specification §6.1: the sforzando pair from Welte's step-count controls in Skala-Rolle §§4 and 6 " +
        ...
        note: "NOT FITTED, and no green roll stands behind any of it. Every level is stated at a hook of 0.5 and moves " +
...
export const instrumentsT98 = () => [
    ...Object.values(GENUINE),
    ...Object.values(DERIVED),
    STARTING_VALUES,
];
export function instrumentT98Of(name) {
    if ("genuine" in name)
        return GENUINE[name.genuine];
    if ("derived" in name)
