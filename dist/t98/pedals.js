 ...
 */
import { heldCommand, pedalDefaults, pedalTravel, } from "../core/pedal.js";
export const T98_PEDAL_EDGES = { sustainPedal: "bass", hammerRail: "treble" };
/**
 ...
 * either.
 */
export const T98_PEDAL_VALVE = {
    fillMs: 11.7,
    tailMs: 52,
    tripThreshold: 0.25,
    band: 1,
};
export const T98_PEDALS = {
