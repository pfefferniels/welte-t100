 ...
 */
export { aperturePorts, DYNAMIC_CONTROLS, HALVES, meaningOf, portKey, portOf, shiftedPortOf, slots, type CodeMeaning, type Control, type Half, type PortKey, type Punch, } from "./codes.ts";
export { CHAIN_GAP_MM, CHAIN_GAP_ROWS, DEFAULT_T98_GEOMETRY, PUNCH_T98_MM, TRACKER_BORE_T98_MM, } from "./geometry.ts";
...
export { DERIVED, GENUINE, instrumentsT98, instrumentT98Of, labelOf, nuanceOf, STARTING_VALUES, type DerivedPair, type DerivedProvenance, type GenuineProvenance, type GenuineRoll, type UnfittedProvenance, type WelteT98Instrument, type WelteT98InstrumentName, } from "./instruments.ts";
