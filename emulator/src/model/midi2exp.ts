...
import { latched, momentary, portOf } from "./latch.ts";
...
function run(input: ModelInput, params: Parameters): Float64Array {
  const { piano, mezzoforte, forte, loud, slowMs, fastCrescendoMs, fastDecrescendoMs } = params as Record<
    string,
    number
  >;
...
export const midi2expModel: Model = {
  name: "midi2exp",
